...
internal class DefaultTileProcessor<T_Query> : TileProcessor<Tile<T_Query>> where T_Query : ITileQuery
{
	...
	internal TileQueryProcessor<T_Query> QueryProcessor => _tileQueryProcessor;
	...
	{
		return !_tileQueryProcessor.IsSatisfiable(tile.Query);
	}
	...
	{
		if (IsContainedIn(arg1, arg2))
		{
			return IsContainedIn(arg2, arg1);
		}
		return false;
	}
}
