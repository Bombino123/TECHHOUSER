...
public static class DbFunctions
{
	...
	{
		return BootstrapFunction((IEnumerable<decimal> c) => StandardDeviation(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<double> c) => StandardDeviation(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<int> c) => StandardDeviation(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<long> c) => StandardDeviation(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<decimal> c) => StandardDeviationP(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<double> c) => StandardDeviationP(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<int> c) => StandardDeviationP(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<long> c) => StandardDeviationP(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<decimal> c) => Var(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<double> c) => Var(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<int> c) => Var(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<long> c) => Var(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<decimal> c) => VarP(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<double> c) => VarP(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<int> c) => VarP(c), collection);
	}
	...
	{
		return BootstrapFunction((IEnumerable<long> c) => VarP(c), collection);
	}
