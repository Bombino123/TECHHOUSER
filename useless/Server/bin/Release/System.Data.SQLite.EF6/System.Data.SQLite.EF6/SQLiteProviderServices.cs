...
internal sealed class SQLiteProviderServices : DbProviderServices, ISQLiteSchemaExtensions
{
	...
	void ISQLiteSchemaExtensions.BuildTempSchema(SQLiteConnection cnn)
	{
		...
		try
		{
			((DbCommand)(object)val).CommandText = System.Data.SQLite.EF6.Properties.Resources.SQL_CONSTRAINTS;
			((DbCommand)(object)val).ExecuteNonQuery();
			((DbCommand)(object)val).CommandText = System.Data.SQLite.EF6.Properties.Resources.SQL_CONSTRAINTCOLUMNS;
			((DbCommand)(object)val).ExecuteNonQuery();
		}
		finally
		{
