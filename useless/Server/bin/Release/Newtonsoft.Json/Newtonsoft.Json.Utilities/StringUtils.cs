...
internal static class StringUtils
{
	...
	public static TSource ForgivingCaseSensitiveFind<TSource>(this IEnumerable<TSource> source, Func<TSource, string> valueSelector, string testValue)
	{
		...
		IEnumerable<TSource> source2 = source.Where((TSource s) => string.Equals(valueSelector2(s), testValue2, StringComparison.OrdinalIgnoreCase));
		if (source2.Count() <= 1)
		{
			return source2.SingleOrDefault();
		}
		return source.Where((TSource s) => string.Equals(valueSelector2(s), testValue2, StringComparison.Ordinal)).SingleOrDefault();
	}
