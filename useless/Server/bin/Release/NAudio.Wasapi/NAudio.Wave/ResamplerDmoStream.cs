...
public class ResamplerDmoStream : WaveStream
{
	...
	public override long Length
	{
		get
		{
			...
			return InputToOutputPosition(((Stream)(object)inputStream).Length);
		}
	}
	...
	public override long Position
	{
		...
		set
		{
			...
			((Stream)(object)inputStream).Position = OutputToInputPosition(value);
			position = InputToOutputPosition(((Stream)(object)inputStream).Position);
	...
	public ResamplerDmoStream(IWaveProvider inputProvider, WaveFormat outputFormat)
	{
		...
		inputStream = (WaveStream)(object)((inputProvider is WaveStream) ? inputProvider : null);
