...
public class Transaction2FindNext2Request : Transaction2Subcommand
{
	...
	public override byte[] GetParameters(bool isUnicode)
	{
		...
		LittleEndianWriter.WriteUInt16(array, 4, (ushort)InformationLevel);
		LittleEndianWriter.WriteUInt32(array, 6, ResumeKey);
		LittleEndianWriter.WriteUInt16(array, 10, (ushort)Flags);
