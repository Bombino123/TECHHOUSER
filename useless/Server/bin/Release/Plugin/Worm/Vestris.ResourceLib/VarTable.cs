...
public class VarTable : ResourceTableHeader
{
	...
	internal override IntPtr Read(IntPtr lpRes)
	{
		...
		while (ptr.ToInt64() < lpRes.ToInt64() + _header.wLength)
		{
			...
			ptr = new IntPtr(ptr.ToInt64() + Marshal.SizeOf((object)vAR_HEADER));
		}
	...
	internal override void Write(BinaryWriter w)
	{
		...
		ResourceUtil.WriteAt(w, w.BaseStream.Position - position2, position + 2);
