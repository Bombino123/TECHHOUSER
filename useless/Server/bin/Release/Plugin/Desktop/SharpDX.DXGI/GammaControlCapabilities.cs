...
public struct GammaControlCapabilities
{
	...
	public float[] ControlPoints
	{
		get
		{
			return _ControlPoints ?? (_ControlPoints = new float[1025]);
		}
		private set
		{
	...
	internal unsafe void __MarshalFrom(ref __Native @ref)
	{
		...
		fixed (float* ptr = &ControlPoints[0])
		{
			void* ptr2 = ptr;
			fixed (float* ptr3 = &@ref.ControlPoints)
			{
				void* ptr4 = ptr3;
				Utilities.CopyMemory((IntPtr)ptr2, (IntPtr)ptr4, 4100);
			}
		}
	}
	...
	internal unsafe void __MarshalTo(ref __Native @ref)
	{
		...
		fixed (float* ptr = &ControlPoints[0])
		{
			...
			{
				void* ptr4 = ptr3;
				Utilities.CopyMemory((IntPtr)ptr4, (IntPtr)ptr2, 4100);
			}
		}
	}
}
