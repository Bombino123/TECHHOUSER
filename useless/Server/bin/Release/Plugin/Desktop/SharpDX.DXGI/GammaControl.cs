...
public struct GammaControl
{
	...
	public RawColor4[] GammaCurve
	{
		get
		{
			return _GammaCurve ?? (_GammaCurve = new RawColor4[1025]);
		}
		private set
		{
			_GammaCurve = value;
	...
	internal unsafe void __MarshalFrom(ref __Native @ref)
	{
		Scale = @ref.Scale;
		Offset = @ref.Offset;
		fixed (RawColor4* ptr = &GammaCurve[0])
		{
			void* ptr2 = ptr;
			fixed (RawColor4* ptr3 = &@ref.GammaCurve)
			{
				void* ptr4 = ptr3;
				Utilities.CopyMemory((IntPtr)ptr2, (IntPtr)ptr4, 1025 * sizeof(RawColor4));
			}
		}
	}
	...
	internal unsafe void __MarshalTo(ref __Native @ref)
	{
		...
		fixed (RawColor4* ptr = &GammaCurve[0])
		{
			...
			{
				void* ptr4 = ptr3;
				Utilities.CopyMemory((IntPtr)ptr4, (IntPtr)ptr2, 1025 * sizeof(RawColor4));
			}
		}
	}
}
