...
internal interface ITaskFolder
{
	...
	[return: MarshalAs(UnmanagedType.Interface)]
	IRegisteredTask GetTask([NotNull][MarshalAs(UnmanagedType.BStr)] string Path);

	[return: MarshalAs(UnmanagedType.Interface)]
	IRegisteredTaskCollection GetTasks(int flags);

	void DeleteTask([In][NotNull][MarshalAs(UnmanagedType.BStr)] string Name, [In] int flags);

	[return: MarshalAs(UnmanagedType.Interface)]
	IRegisteredTask RegisterTask([In][NotNull][MarshalAs(UnmanagedType.BStr)] string Path, [In][NotNull][MarshalAs(UnmanagedType.BStr)] string XmlText, [In] int flags, [In][MarshalAs(UnmanagedType.Struct)] object UserId, [In][MarshalAs(UnmanagedType.Struct)] object password, [In] TaskLogonType LogonType, [Optional][In][MarshalAs(UnmanagedType.Struct)] object sddl);

	[return: MarshalAs(UnmanagedType.Interface)]
	IRegisteredTask RegisterTaskDefinition([In][NotNull][MarshalAs(UnmanagedType.BStr)] string Path, [In][NotNull][MarshalAs(UnmanagedType.Interface)] ITaskDefinition pDefinition, [In] int flags, [In][MarshalAs(UnmanagedType.Struct)] object UserId, [In][MarshalAs(UnmanagedType.Struct)] object password, [In] TaskLogonType LogonType, [Optional][In][MarshalAs(UnmanagedType.Struct)] object sddl);
